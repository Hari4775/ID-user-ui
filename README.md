...
# DEPLOYMENT
-signup aws -launch instance -chmod 400 LAKSHADWEEP.pem

-ssh -i "LAKSHADWEEP.pem" ubuntu@ec2-13-60-180-199.eu-north-1.compute.amazonaws.com -install node version (nvm install 20.15.1) -git clone https://
